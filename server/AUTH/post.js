...
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                result = _a.sent();
                if (!(result.id !== null)) return [3 /*break*/, 6];
                return [4 /*yield*/, email_1["default"](to, subject, text)];
            case 4:
                _a.sent();
                return [4 /*yield*/, mysqlUser.createOnline(result.id)];
            case 5:
                _a.sent();
...
router.post('/signup/submit', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
router.post('/signout', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
router.post('/online', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
router.post('/offline', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, error_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
